      ...
      <div class="row justify-content-evenly">
        ...
        <div class="col-lg-6">
          <div class="section info text-card">
            ...
            <a href="https://www.universe.com/events/family-quest-dagquest-tickets-C6PYX3" class="button-link">
      ...
      <div class="row justify-content-evenly">
        ...
        <div class="col-lg-6">
          <div class="section info text-card">
            ...
            <a href="https://www.universe.com/events/fantasy-quest-aftenquest-tickets-2PCHR4" class="button-link">
                <button>Køb billet</button>
            </a>
          </div>
        </div>
    ...
    <div class="section">
      <div class="tekst">
        ...
        <h6>
          ...
          <strong> Det bliver megasjovt, anderledes og spændende. </strong>
        </h6>
      </div>
    </div>
  </div>
